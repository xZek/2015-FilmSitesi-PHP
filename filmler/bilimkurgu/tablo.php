...
<div class="container">
  <div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
      <div class="row">
        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-2"><a href="/telif.php"><img class="btn btn-default" alt="" src="img/icon-3.jpg	"></a></div>
...
<hr>
<center><img src="img/blmkurgu.png" ></center>